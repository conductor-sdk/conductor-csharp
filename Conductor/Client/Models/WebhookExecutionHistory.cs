...
namespace Conductor.Client.Models
{
    ...
    public partial class WebhookExecutionHistory : IEquatable<WebhookExecutionHistory>, IValidatableObject
    {
        ...
        public WebhookExecutionHistory(string eventId = default(string), bool? matched = default(bool?), string payload = default(string), long? timeStamp = default(long?), List<string> workflowIds = default(List<string>))
        {
