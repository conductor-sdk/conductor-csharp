...
namespace Conductor.Client.Models
{
    ...
    public partial class TagString : IEquatable<TagString>, IValidatableObject
    {
        ...
        public TagString(string key = default(string), TypeEnum? type = default(TypeEnum?), string value = default(string))
        {
            this.Key = key;
            this.Type = type;
            this.Value = value;
        ...
        {
            return this.Equals(input as TagString);
        }

        /// <summary>
        /// Returns true if TagString instances are equal
        /// </summary>
        /// <param name="input">Instance of TagString to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagString input)
        {
            if (input == null)
                return false;
