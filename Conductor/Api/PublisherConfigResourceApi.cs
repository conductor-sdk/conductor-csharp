...
namespace Conductor.Api
{
        ...
        public partial class PublisherConfigResourceApi : IPublisherConfigResourceApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublisherConfigResourceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PublisherConfigResourceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PublisherConfigResourceApi(Conductor.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< string > DownloadConfigWithHttpInfo (string id)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DownloadConfig", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< Object > ListAllConfigsWithHttpInfo ()
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListAllConfigs", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< Object > UploadConfigWithHttpInfo (string body, string id)
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling PublisherConfigResourceApi->UploadConfig");
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UploadConfig", localVarResponse);
                if (exception != null) throw exception;
            }
