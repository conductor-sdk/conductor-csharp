...
namespace Conductor.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class OneofOptions : IEquatable<OneofOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneofOptions" /> class.
        /// </summary>
        ...
        public OneofOptions(UnknownFieldSet unknownFields = default(UnknownFieldSet), bool? initialized = false, ParserOneofOptions parserForType = default(ParserOneofOptions), OneofOptions defaultInstanceForType = default(OneofOptions), int? serializedSize = default(int?), List<UninterpretedOption> uninterpretedOptionList = default(List<UninterpretedOption>), List<UninterpretedOptionOrBuilder> uninterpretedOptionOrBuilderList = default(List<UninterpretedOptionOrBuilder>), int? uninterpretedOptionCount = default(int?), string initializationErrorString = default(string), Descriptor descriptorForType = default(Descriptor), Dictionary<string, Object> allFields = default(Dictionary<string, Object>), Dictionary<string, Object> allFieldsRaw = default(Dictionary<string, Object>))
        {
        ...
        {
            return this.Equals(input as OneofOptions);
        }

        /// <summary>
        /// Returns true if OneofOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of OneofOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneofOptions input)
        {
            if (input == null)
                return false;
