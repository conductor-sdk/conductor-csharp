...
namespace Conductor.Client.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnumOptions :  IEquatable<EnumOptions>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="allowAlias">allowAlias (default to false).</param>
        ...
        public EnumOptions(UnknownFieldSet unknownFields = default(UnknownFieldSet), bool? initialized = false, ParserEnumOptions parserForType = default(ParserEnumOptions), EnumOptions defaultInstanceForType = default(EnumOptions), int? serializedSize = default(int?), bool? deprecated = false, List<UninterpretedOption> uninterpretedOptionList = default(List<UninterpretedOption>), List<UninterpretedOptionOrBuilder> uninterpretedOptionOrBuilderList = default(List<UninterpretedOptionOrBuilder>), int? uninterpretedOptionCount = default(int?), bool? allowAlias = false, string initializationErrorString = default(string), Descriptor descriptorForType = default(Descriptor), Dictionary<string, Object> allFields = default(Dictionary<string, Object>), Dictionary<string, Object> allFieldsRaw = default(Dictionary<string, Object>))
        {
            ...
            // use default value if no "allowAlias" provided
            if (allowAlias == null)
            {
        ...
        /// <summary>
        /// Gets or Sets AllowAlias
        /// </summary>
        [DataMember(Name="allowAlias", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AllowAlias: ").Append(AllowAlias).Append("\n");
        ...
        {
            return this.Equals(input as EnumOptions);
        }

        /// <summary>
        /// Returns true if EnumOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of EnumOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnumOptions input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AllowAlias == input.AllowAlias ||
                    (this.AllowAlias != null &&
                    this.AllowAlias.Equals(input.AllowAlias))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AllowAlias != null)
                    hashCode = hashCode * 59 + this.AllowAlias.GetHashCode();
