...
namespace Conductor.Client.Models
{
    ...
    public partial class EnumValueOptions :  IEquatable<EnumValueOptions>, IValidatableObject
    {
        ...
        public EnumValueOptions(UnknownFieldSet unknownFields = default(UnknownFieldSet), bool? initialized = false, ParserEnumValueOptions parserForType = default(ParserEnumValueOptions), EnumValueOptions defaultInstanceForType = default(EnumValueOptions), int? serializedSize = default(int?), bool? deprecated = false, List<UninterpretedOption> uninterpretedOptionList = default(List<UninterpretedOption>), List<UninterpretedOptionOrBuilder> uninterpretedOptionOrBuilderList = default(List<UninterpretedOptionOrBuilder>), int? uninterpretedOptionCount = default(int?), string initializationErrorString = default(string), Descriptor descriptorForType = default(Descriptor), Dictionary<string, Object> allFields = default(Dictionary<string, Object>), Dictionary<string, Object> allFieldsRaw = default(Dictionary<string, Object>))
        {
        ...
        {
            return this.Equals(input as EnumValueOptions);
        }

        /// <summary>
        /// Returns true if EnumValueOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of EnumValueOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnumValueOptions input)
        {
            if (input == null)
                return false;
